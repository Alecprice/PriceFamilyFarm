      ...
      <main id="main-content" tabIndex={-1}>
        <header className="page-head">
          <div className="wrap">
            ...
            <p>The crops below reflect what Price Family Farm is growing, establishing, or propagating across the orchard, greenhouse, and container rows in Greene County. Harvest and plant-start availability is confirmed separately as each crop reaches a sellable stage.</p>
          </div>
        </header>
