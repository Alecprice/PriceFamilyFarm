...
export default function FarmPlanner() {
  ...
  return (
    <div className="farm-tools-shell">
      ...
      <div className="farm-actions"><Link className="farm-action secondary" href="/farm-os/calendar">Open Farm Calendar</Link><Link className="farm-action secondary" href="/weather">Check growing conditions</Link><Link className="farm-action secondary" href="/farm-os">Back to Farm OS</Link></div>
    </div>
  );
}
